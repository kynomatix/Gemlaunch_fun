...
- [x] **2.11** Image Storage & Metadata (CRITICAL FIX) ✅ IMPLEMENTED
  - [x] PROBLEM: Replicate URLs are temporary (expire after 24-48h)
  - [x] SOLUTION CHOSEN: **IPFS via Pinata** (Option A) ✅
    - Images generated by Replicate are immediately uploaded to IPFS
    - Permanent storage using Pinata IPFS pinning service
    - IPFS URL format: `ipfs://QmXg7Hf8QFyPKJr6...`
  ...
  - [x] Implementation Details:
    ...
    - Downloads Replicate image and uploads to Pinata
    - Returns both IPFS URL (for database) and gateway URL (for display)
    - Proper error handling and timeout management (60s download, 120s upload)
