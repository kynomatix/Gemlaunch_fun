...
async function main() {
    console.log("\n" + "=".repeat(80));
    console.log("🚀 Deploying GraduationController V8");
    ...
    const GRADUATION_ORACLE = "0x5f837F62744D4d80Fc79C3A5346B4A228956914E";  // FIX: Correct oracle!
    const TOKEN_FACTORY_V10 = "0xCD8e8F442E187B811130F8924B91a8F3445Ffb21";
    ...
    console.log("Token Factory V10:            ", TOKEN_FACTORY_V10);
    ...
    const gc = await GraduationController.deploy(
        ...
        KASPA_FINANCE_WKAS,
        GRADUATION_ORACLE,  // FIX: Using oracle, NOT treasury!
        TOKEN_FACTORY_V10,
        TREASURY
    );
    ...
    console.log("\n" + "=".repeat(80));
    console.log("✅ GraduationController V8 deployed to:", gcAddress);
    console.log("=".repeat(80));
    ...
    if (deployedFactory.toLowerCase() !== TOKEN_FACTORY_V10.toLowerCase()) {
    ...
    console.log("2. Deploy TokenFactory V11 with GC V8 address");
