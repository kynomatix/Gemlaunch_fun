...
async function main() {
  console.log("\n🚀 Deploying GraduationController V2 to Kasplex Testnet...\n");
  ...
  // Use fully qualified name to avoid conflict with V1 contract
  const GraduationController = await hre.ethers.getContractFactory(
    "contracts/GraduationControllerV2.sol:GraduationController"
  );
  ...
  console.log("\n🏗️  Deploying GraduationController V2 Contract...");
  console.log("=".repeat(80));
  ...
  console.log("\n🎉 GraduationController V2 Deployed Successfully!");
  console.log("=".repeat(80));
  ...
  try {
    ...
    console.log("   ✓ Graduation Deadline:", deadlineSeconds.toString(), "seconds");
    ...
    const verifications = [
      ...
      { name: "Version", expected: "2.0.0", actual: version }
    ];
  ...
  const deploymentFile = path.join(deploymentsDir, "graduation_controller_v2.json");
  ...
  console.log("\n📊 Deployment Summary:");
  console.log("=".repeat(80));
  console.log("   Contract: GraduationController V2");
  ...
  console.log("\n📌 Next Steps:");
  console.log("=".repeat(80));
  console.log("   1. ✓ GraduationController V2 deployed successfully");
  ...
  console.log("      - Reach graduation threshold");
  console.log("      - Trigger graduation via oracle");
  console.log("      - Verify Uniswap V3 pool creation and liquidity");
  console.log("");
  ...
  console.log("\n" + "=".repeat(80));
  console.log("✅ DEPLOYMENT COMPLETE - GRADUATION CONTROLLER V2");
  console.log("=".repeat(80) + "\n");
