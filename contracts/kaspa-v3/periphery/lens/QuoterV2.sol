...
import '../../core/interfaces/callback/IKaspaV3SwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, IKaspaV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IKaspaV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IKaspaV3Pool) {
        return IKaspaV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IKaspaV3SwapCallback
    function KaspaV3SwapCallback(
        ...
        IKaspaV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IKaspaV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
